  ...
  return (
    <div className="container">
      <div className="row mb-5 mt-5" >
        <h1 className="fs-2 mb-5 mt-3  text-center" style={{color:"rgb(45, 48, 48)"}}> We pioneered the discount broking model in India .<br/>
        Now, we are breaking the ground with our technology. </h1>
      </div>
      <div className="row mt-5 border-top  " style={{lineHeight: "1.5" , fontSize:"1.2em"}}>
        <div className="col-1"></div>
        <div className="col-5 text-muted mt-5 p-5 ">
