...
app.use(
  cors({
    origin: ["https://zerodha-frontend-m41e.onrender.com","http://localhost:3000"],  // Allow only your frontend ,dashboard both
...
//     });
//     newPosition.save();
//     res.send("Done Positions data inserted successfully !");
//   })
// })
